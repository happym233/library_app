...
export default function Loans() {
  ...
  useEffect(() => {
    ...
    agent.Book.fetchUserCurrentLoans(authState)
      .then((response) => {
        setShelfCurrentLoans(response);
      })
      .catch((error: any) => {
  ...
  async function returnBook(bookId: number) {
    agent.Book.returnBook(bookId, authState).then((response) => {
      setCheckout(!checkout);
    });
  }

  async function renewLoan(bookId: number) {
    agent.Book.renewLoan(bookId, authState).then((response) => {
      setCheckout(!checkout);
    });
  }
